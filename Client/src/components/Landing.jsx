...
export default function Landing() {
  ...
  return (
    <section id="landing" className="relative min-h-screen flex items-center justify-center px-4 py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 overflow-hidden">
      ...
      <motion.div
        className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center"
      ...
      >
        ...
        >
          <div className="relative group">
            ...
            <div
              className="relative w-80 h-80 rounded-full bg-gradient-to-br from-blue-400 to-indigo-600 p-1 shadow-premium-lg"
            >
        ...
        >
          ...
          >
            <motion.div 
              ...
              whileHover={{ y: -5 }}
            >
              <p className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">10</p>
            ...
            <motion.div 
              ...
              whileHover={{ y: -5 }}
            >
              <p className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">3+</p>
          ...
          >
            <motion.a
              href="#projects"
              className="px-8 py-3 bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 text-white rounded-lg font-semibold shadow-premium-lg hover:shadow-premium-lg transition-all duration-300"
            ...
            <motion.a
              href="#contact"
              className="px-8 py-3 border-2 border-indigo-600 dark:border-indigo-400 text-indigo-600 dark:text-indigo-400 rounded-lg font-semibold hover:bg-indigo-50 dark:hover:bg-gray-800 hover:shadow-premium transition-all duration-300"
              whileHover={{ scale: 1.08, y: -2 }}
              whileTap={{ scale: 0.95 }}
            >
              Get in Touch
