        ...
        >
          {experiences.map((exp, idx) => (
            ...
            >
              ...
              {/* Timeline Dot */}
              <div className="absolute left-0 md:left-0 top-3 w-12 h-12 md:w-12 md:h-12 bg-gradient-to-br from-indigo-600 to-blue-600 rounded-full flex items-center justify-center shadow-lg">
                <FaBriefcase className="text-white text-lg" />
              </div>

              {/* Content Card */}
              <div className="ml-16 md:ml-24 bg-white dark:bg-gray-900 rounded-xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400 font-semibold mt-4 md:mt-0 bg-indigo-50 dark:bg-indigo-900 px-4 py-2 rounded-lg">
                ...
                <div className="flex flex-wrap gap-2">
                  {exp.highlights.map((skill) => (
                    <motion.span
                      key={skill}
                      className="px-4 py-2 bg-gradient-to-r from-indigo-100 to-blue-100 dark:from-indigo-900 dark:to-blue-900 text-indigo-700 dark:text-indigo-300 rounded-full text-sm font-semibold"
